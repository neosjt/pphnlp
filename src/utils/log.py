"""
    pph
    2020.11.20
    想了想，还是定义一个全局的logger，将所有的日志汇聚在一个文件中
"""
...
LOG_PATH=ROOT_PATH+"/"+"output/log.txt"
...
def get_logger(log_to_file=False, log_path="./default.log", log_level="DEBUG"):
...
logger=get_logger(log_to_file=True,log_path=LOG_PATH)
